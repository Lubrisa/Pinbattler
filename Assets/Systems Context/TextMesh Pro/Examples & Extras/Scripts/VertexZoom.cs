        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    Vector2[] sourceUVs0 = new Vector2[cachedMeshInfoVertexData.Length];
                    for (int j = 0; j < cachedMeshInfoVertexData.Length; j++)
                    {
                        sourceUVs0[j] = cachedMeshInfoVertexData[materialIndex].uvs0[j];
                    }
                    Vector2[] destinationUVs0 = new Vector2[textInfo.meshInfo.Length];
                    for (int j = 0; j < textInfo.meshInfo.Length; j++)
                    {
                        destinationUVs0[j] = textInfo.meshInfo[materialIndex].uvs0[j];
                    }
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    for (int j = 0; j < textInfo.meshInfo.Length; j++)
                    {
                        textInfo.meshInfo[i].mesh.uv[j] = textInfo.meshInfo[i].uvs0[j];
                    }
